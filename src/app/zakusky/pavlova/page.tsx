...
export default function PavlovaPage() {
  return (
        ...
        <div className="space-y-8 text-left max-w-xl">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-snug">
              Nadýchaná sněhová pusinka s jemným krémem z mascarpone,
              doplněná ovocnými nebo karamelovými náplněmi. Lehký a elegantní
              dezert, který vynikne na každém sweet baru.
            </p>
          </div>
          ...
          <div className="space-y-2 pt-4">
            ...
            <p className="text-muted-foreground leading-snug">
              Pavlovy jsou z důvodu své křehkosti plněny až těsně před odběrem.
              Doporučuji jejich konzumaci do <strong>24 hodin</strong>.
            </p>
        ...
        <div className="w-full flex justify-start md:justify-center">
          <div className="w-full max-w-xs md:max-w-sm">
            ...
            >
              <CarouselContent>
                {[
                  "/images/zakusky/pavlova/1.jpg",
                  "/images/zakusky/pavlova/2.jpg",
                ].map((src, i) => (
                  <CarouselItem key={i}>
