...
export default function SklenickoveDesertyPage() {
  return (
        ...
        <div className="space-y-8 text-left max-w-xl">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-snug">
              Lehký a elegantní dezert servírovaný ve skleničce, který
              kombinuje krémy, ovoce, piškot nebo křupavé vrstvy.
              Skleničkové dezerty jsou praktické na servírování a velmi
              oblíbené jako součást sweet baru.
            </p>
          </div>
          ...
          <div className="space-y-1 text-muted-foreground">
            ...
            <p>
              <strong>Cena:</strong> od 80 Kč / ks
            </p>
          </div>
        ...
        <div className="w-full flex justify-start md:justify-center">
          <div className="w-full max-w-xs md:max-w-sm">
            ...
            >
              <CarouselContent>
                {[
                  "/images/zakusky/sklenickove-deserty/1.jpg",
                  "/images/zakusky/sklenickove-deserty/2.jpg",
                  "/images/zakusky/sklenickove-deserty/3.jpg",
                  "/images/zakusky/sklenickove-deserty/4.jpg",
                  "/images/zakusky/sklenickove-deserty/5.jpg",
                ].map((src, i) => (
                  <CarouselItem key={i}>
                    <div className="relative aspect-[3/4] rounded-xl overflow-hidden shadow-md">
                      <Image
                        src={src}
                        alt={`Skleničkové deserty ${i + 1}`}
                        fill
