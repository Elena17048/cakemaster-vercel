...
export default function ParisBrestPage() {
  return (
        ...
        <div className="space-y-8 text-left max-w-xl">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-snug">
              Tradiční francouzský dezert z odpalovaného těsta, plněný jemným
              krémem. Paris-Brest je ikonická klasika inspirovaná cyklistickým
              závodem mezi Paříží a Brestem a jeho charakteristický kruhový
              tvar z něj dělá nepřehlédnutelný prvek sweet baru.
            </p>
          </div>
        ...
        <div className="w-full flex justify-start md:justify-center">
          <div className="w-full max-w-xs md:max-w-sm">
            ...
            >
              <CarouselContent>
                {[
                  "/images/zakusky/paris-brest/1.jpg",
                ].map((src, i) => (
                  <CarouselItem key={i}>
