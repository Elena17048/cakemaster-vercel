...
export default function TartaletkyPage() {
  return (
        ...
        <div className="space-y-8 text-left max-w-xl">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-snug">
              Křehké máslové košíčky plněné jemnými krémy a doplněné ovocem,
              karamelem nebo čokoládou. Tartaletky jsou elegantní a chuťově
              vyvážené dezerty, které krásně vyniknou na sweet baru.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-muted-foreground">
              {[
                "Citronové",
                "Vanilkové s jahodámi",
                "Čokoládové s malinami",
                "Čokoládové s mango a maraquiou",
                "Tropické s kokosem a limetkou",
                "Pistáciové s borůvkami",
                "Praliné",
              ].map((flavour) => (
        ...
        <div className="w-full flex justify-start md:justify-center">
          <div className="w-full max-w-xs md:max-w-sm">
            ...
            >
              <CarouselContent>
                {[
                  "/images/zakusky/tartaletky/1.jpg",
                  "/images/zakusky/tartaletky/2.jpg",
                ].map((src, i) => (
                  <CarouselItem key={i}>
